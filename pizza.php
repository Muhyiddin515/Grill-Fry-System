...
$pizza_items_stmt = $connection->prepare("SELECT * FROM menu_items WHERE type_id = 3");
$pizza_items_stmt->execute();
$pizza_items = $pizza_items_stmt->get_result();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section class="Menu">
    <div class="nav">
        ...
        <ul>
            ...
            <li><a class="active" href="pizza.php">Pizza</a></li>
...
<?php while($item = $pizza_items->fetch_assoc()): ?>
