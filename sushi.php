...
//get sushi items
$sushi_items_stmt = $connection->prepare("SELECT * FROM menu_items WHERE type_id = 1");
$sushi_items_stmt->execute();
$sushi_items = $sushi_items_stmt->get_result();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section class="Menu">
    <div class="nav">
        ...
        <ul>
            ...
            <li><a class="active" href="sushi.php">Sushi</a></li>
...
<?php while($item = $sushi_items->fetch_assoc()): ?>
...
<div class="menu-item" data-price="<?= $item['price'] ?>">
    ...
    <form method="post">
        ...
        <input type="hidden" class="php-qty" name="quantity" value="1">
