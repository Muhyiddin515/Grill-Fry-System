...
$meat_items_stmt = $connection->prepare("SELECT * FROM menu_items WHERE type_id = 4");
$meat_items_stmt->execute();
$meat_items = $meat_items_stmt->get_result();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section class="Menu">
    <div class="nav">
        ...
        <ul>
            ...
            <li><a class="active" href="meat.php">Meats</a></li>
...
<?php while($item = $meat_items->fetch_assoc()): ?>
