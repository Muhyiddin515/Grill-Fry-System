...
$burger_items_stmt = $connection->prepare("SELECT * FROM menu_items WHERE type_id = 2");
$burger_items_stmt->execute();
$burger_items = $burger_items_stmt->get_result();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section class="Menu">
    <div class="nav">
        ...
        <ul>
            ...
            <li><a class="active" href="burger.php">Burgers</a></li>
            <li><a href="pizza.php">Pizza</a></li>
            <li><a href="meat.php">Meats</a></li>
            <li><a href="drinks.php"> Drinks</a></li>
            <li><a href="voiceorder.php">Voice Order</a></li>
...
<?php while($item = $burger_items->fetch_assoc()): ?>
